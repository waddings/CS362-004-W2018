...
void adventurerCard(int *drawntreasure, int *currentPlayer, int *cardDrawn, int *temphand, int *z, struct gameState *state){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    {
    case adventurer:
      adventurerCard(&drawntreasure, &currentPlayer, &cardDrawn, temphand, &z, state);
      return 0;
